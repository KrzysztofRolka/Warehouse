 ...
 */
package pl.warehouse.jsf.authorization.web;
...
public class Resources {
  ...
  @PersistenceContext(unitName = "WarehouseDS")
  private EntityManager em;

  /*
   * Since we are using JPAIdentityStore to store identity-related data, we must provide it with an
   * EntityManager via a producer method or field annotated with the @PicketLink qualifier.
   */
  @Produces
  @PicketLink
